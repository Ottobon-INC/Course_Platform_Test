...
export async function askCourseAssistant(options) {
    ...
    try {
        ...
        if (contexts.length === 0) {
            ...
            return {
                answer: "I don't have enough details in the course materials to answer that. Could you try asking about another topic covered here?",
            };
        }
...
async function fetchRelevantContexts(session, courseId, embedding) {
