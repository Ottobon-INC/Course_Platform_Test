...
certificatesRouter.get("/:courseKey", requireAuth, asyncHandler(async (req, res) => {
...
certificatesRouter.post("/:courseKey/feedback", requireAuth, asyncHandler(async (req, res) => {
    const { courseKey } = req.params;
    const parsedQuery = querySchema.safeParse({
        programType: typeof req.query.programType === "string" ? req.query.programType : undefined,
    });
