...
coldCallRouter.get("/prompts/:topicId", requireAuth, asyncHandler(async (req, res) => {
    const auth = req.auth;
    if (!auth) {
...
coldCallRouter.post("/messages", requireAuth, asyncHandler(async (req, res) => {
    const auth = req.auth;
    if (!auth) {
        res.status(401).json({ message: "Unauthorized" });
        return;
...
coldCallRouter.post("/replies", requireAuth, asyncHandler(async (req, res) => {
    const auth = req.auth;
    if (!auth) {
        res.status(401).json({ message: "Unauthorized" });
        return;
...
coldCallRouter.post("/stars", requireAuth, asyncHandler(async (req, res) => {
    const auth = req.auth;
    if (!auth) {
        res.status(401).json({ message: "Unauthorized" });
        return;
...
coldCallRouter.delete("/stars/:messageId", requireAuth, asyncHandler(async (req, res) => {
    const auth = req.auth;
    if (!auth) {
        res.status(401).json({ message: "Unauthorized" });
        return;
