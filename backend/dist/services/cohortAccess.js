...
export const COHORT_ACCESS_DENIED_MESSAGE = "You are not in the cohort batch, please register first.";
const ACTIVE_MEMBER_STATUS = "active";
const toLowerEmail = (value) => value.trim().toLowerCase();
const listActiveCohorts = async (courseId) => {
    if (!courseId) {
        return [];
    }
...
export const checkCohortAccessForUser = async (userId, courseId, activeCohorts) => {
...
export const checkCohortAccessFromRequest = async (req, courseId) => {
