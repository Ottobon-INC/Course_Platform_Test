...
export function Navbar() {
  ...
  const hideSearch = location.pathname === '/' || location.pathname === '/student-dashboard' || location.pathname === '/my-courses' || location.pathname === '/leaderboard' || location.pathname === '/messages' || location.pathname === '/feedback' || location.pathname === '/settings' || location.pathname === '/analysis' || location.pathname === '/certificates' || location.pathname === '/cohorts';
