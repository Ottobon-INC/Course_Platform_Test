...
1. Visiting `/course/ai-native-fullstack-developer` loads `CourseDetailsPage.tsx`, which fetches `/courses/:slug` and `/lessons/courses/:slug/topics` to render live curriculum data.
